  ...
  const paymentMethods = [
    {
      ...
      icon: <span className="text-2xl text-blue-600">💳</span>,
    ...
    },
    {
      id: 'upi',
      name: 'UPI Payment',
      icon: <span className="text-2xl text-purple-600">📱</span>,
  ...
  const upiApps = [
    {
      id: 'phonepe',
      name: 'PhonePe',
      icon: <span className="text-2xl text-purple-600">Pe</span>,
      color: 'bg-purple-100 border-purple-300'
    },
    {
      id: 'googlepay',
      name: 'Google Pay',
      icon: <span className="text-2xl text-blue-600">G</span>,
      color: 'bg-blue-100 border-blue-300'
    },
    {
      id: 'paytm',
      name: 'Paytm',
      icon: <span className="text-2xl text-blue-700">Ptm</span>,
      color: 'bg-blue-100 border-blue-300'
    }
  ];
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                {selectedMethod === method.id && (
                  <span className="text-luxury-gold mt-1 ml-auto">✓</span>
                )}
              </div>
            </div>
          </div>
